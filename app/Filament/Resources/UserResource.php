...
class UserResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        if(config('filament-user.shield')){
            $rows[] = Forms\Components\MultiSelect::make('roles')->relationship('roles', 'name')->label(trans('filament-user::user.resource.roles'))->preload();
        }
    ...
    public static function table(Table $table): Table
    {
        $table
            ->columns([
                ...
                TextColumn::make('name')->sortable()->searchable()->label('Usuario'),
                TextColumn::make('email')->sortable()->searchable()->label('Correo'),
                TextColumn::make('roles.name')->label('Rol'),
                BooleanColumn::make('email_verified_at')->sortable()->searchable()->label('Verificado'),
